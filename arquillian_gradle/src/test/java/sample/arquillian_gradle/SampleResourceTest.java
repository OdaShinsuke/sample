...
public class SampleResourceTest {
  ...
  private static String convApiUri(String apiPath) {
    String basePath = "http://" + TEST_SERVER + "/arquillian_gradle/api";
  ...
  public void get() {
    ...
    Assert.assertEquals("Hello, abc", actual);
  }
  ...
  public static WebArchive createDeployment() {
    ...
    return ShrinkWrap.create(WebArchive.class, "arquillian_gradle.war")
      .addClasses(SampleApplication.class, SampleResource.class)
      .addAsWebInfResource(webinf.resolve("web.xml").toFile())
      .addAsWebInfResource(webinf.resolve("beans.xml").toFile())
      .addAsLibraries(Paths.get("build", "output", "libs").toFile().listFiles());
  }
}
